        ...
        <section className="footer">
            <section className="footer__content">
                <section className="footer__brand">
                    <img src="./assets/hhr-logo.svg" alt="Hybrid Hiring Solutions Logo" className="footer__logo" /> {/* need to add the image */}
                ...
                <section className="footer__socials">
                    ...
                    <a><img src="./assets/facebook-logo.svg" alt="Facebook Logo" className="footer__socials-icon" /></a>
                    <a><img src="./assets/linkedin-logo.svg" alt="LinkedIn Logo" className="footer__socials-icon" /></a>
                    <a><img src="./assets/instagram-logo.svg" alt="Instagram Logo" className="footer__socials-icon" /></a>
                </section>
                <section className="footer__copyright">
                    <hr style={{ border: 'none', borderTop: '1px solid #fff', marginTop: 20, marginBottom: 20 }} />
                    <p className="footer__copyright-text">Legal Disclaimer: This is a legal disclaimer.</p> {/* find out what needs to go here */}
                    <hr style={{ border: 'none', borderTop: '1px solid #fff', marginTop: 20, marginBottom: 20 }} />
                    <p className="footer__copyright-text">© Hybrid Hiring Solutions 2025 All Rights Reserved</p>
                </section>
            </section>
        </section>
    )
